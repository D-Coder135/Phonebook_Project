...
public class ContactService {
    ...
    public Contact getContactById(Integer id) throws IOException {
        return DaoFactory.getContactDao().getContact(id);
    }

    public List<Contact> getAllContacts(Integer id) throws IOException {
